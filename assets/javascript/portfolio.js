...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'youtube',
                link: 'https://www.youtube.com/zuhn'
            },

		    {
                name: 'twitter',
                link: 'https://www.twitter.com/zuhn'
            },

            {
                name: 'discord',
                link: 'https://discord.gg/cloaks'
            },
            
            {
                name: 'dstat',
                link: 'https://zuhn.wtf/dstat'
            },
            
            {
                name: 'solo',
                link: 'https://solo.to/zuhn'
            },
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=30d699539d85469f8f7d007ae2628d05', function (data) { 

            writeLine(["Authenticating...", "Attempting to grant access to <span style='font-size: 14px; color: #c83232;'>[zuhn.wtf]</span>..."], 30, function () {
                ...
                writeLine(["Access Granted <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Processing..."], 30, 501, function () {
                    ...
                    writeLine(["<i style='color: #c83232'>zuhn.wtf on top.</i>"], 30, 500, function () {
